...
//        populateList();
    ...
    public void onListItemClick(ListView listView, View v, int position, long id) {
        ...
        Toast.makeText(mContext, "Hey: " + id, Toast.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.contribution_fragment, container, false);
...
//            if (((MainActivity)getActivity()).setMapLocationOnSearch(location)) {
